...
namespace Login
{
    public class MailSend : MailSMTP
    {
        ...
        public MailSend(string UserName, string MailPassword, bool SSL, string SMTP, int PORT, string MailTo, string Subject, string Body, string File)
